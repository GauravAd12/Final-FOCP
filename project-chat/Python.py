...
def generate_agent_name():
    agent_names = ["harry", "Saurav", "Ghanshyam", "Beck", "Sam"]
...
class ChatbotApp(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        # Welcome message
        self.chat_display.append(f"<p style='color:green;'>Welcome {self.user_name}! I am {self.agent_name}, your assistant. How can I help you today?</p>")
